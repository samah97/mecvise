...
<nav class="navbar navbar-expand-md navbar-dark py-3 d-block text-center text-lg-left" id="navBlack">
    ...
    Mecvise
        ...
        <div class="container-fluid rounded p-4 bg-white">
            <form action="user/forgetPassword" method="POST" id="loginForm">
                <div class="form-row p-5 flex-column flex-lg-row">
                    ...
                    <div class="col text-center my-1 py-3">
                        ...
                        <div class="col-12 col-lg-9 offset-lg-1">
                            ...
                            <input type="email" id="email" name="Email" class="form-control" placeholder="Please Enter Email Id" value="<?php if(array_key_exists('email',$data)) echo $data['email'] ?>" >
                        </div>
